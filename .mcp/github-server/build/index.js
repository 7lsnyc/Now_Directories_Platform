            ...
            try {
                switch (request.params.name) {
                    ...
                    case 'create_repository': {
                        const { name, description, private: isPrivate, auto_init, gitignore_template, license_template } = request.params.arguments || {};
                        if (!name) {
                    ...
                    case 'create_issue': {
                        ...
                        if (!owner || !repo || !title) {
                            throw new McpError(ErrorCode.InvalidParams, 'Owner, repo, and title are required');
                        }
