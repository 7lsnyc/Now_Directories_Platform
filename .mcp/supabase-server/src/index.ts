...
const isGetNotariesArgs = (args: any): args is { 
  limit?: number; 
  offset?: number; 
  city?: string; 
  state?: string; 
...
const isGetNotaryArgs = (args: any): args is { id: string } => {
  return typeof args === 'object' && args !== null && typeof args.id === 'string';
};

const isCreateNotaryArgs = (args: any): args is {
  name: string;
  city: string;
  state: string;
  services: string[];
  ...
  return typeof args === 'object' && args !== null &&
    ...
    args.services.every((service: any) => typeof service === 'string') &&
...
const isUpdateNotaryArgs = (args: any): args is {
  id: string;
  name?: string;
  city?: string;
  state?: string;
...
const isDeleteNotaryArgs = (args: any): args is { id: string } => {
  return typeof args === 'object' && args !== null && typeof args.id === 'string';
};
      ...
      try {
        switch (name) {
          ...
          case 'update_notary': {
            ...
            if (args.services !== undefined) updateData.services = args.services;
            if (args.rating !== undefined) updateData.rating = args.rating;
            if (args.review_count !== undefined) updateData.review_count = args.review_count;
            if (args.profile_image_url !== undefined) updateData.profile_image_url = args.profile_image_url;
            if (args.about !== undefined) updateData.about = args.about;
